            ...
            <Grid container justifyContent="center" py={6}>
              <Grid item xs={12} md={7} mx={{ xs: 'auto', sm: 6, md: 1 }}>
                ...
                <MKTypography variant="body1" fontWeight="light" color="text">
                  <h3>Welcome to Our Therapy Services</h3>
                  <p>
                  Whether you're seeking support for anxiety, depression, or simply navigating life's challenges, our compassionate team is here to help.<br/> We offer a safe space where you can find the support you need to thrive.
                  <br/><br/>
                  Reach out today to book your appointment and start your journey toward emotional well-being.
                  </p>
                  <MKTypography
                      component="a"
                      href="#"
